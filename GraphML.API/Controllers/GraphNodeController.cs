...
namespace GraphML.API.Controllers
{
  ...
  public sealed class GraphNodeController : OwnedGraphMLController<GraphNode>
  {
    ...
    public override ActionResult<PagedDataEx<GraphNode>> ByOwners([FromBody] [Required] IEnumerable<Guid> ownerIds, [FromQuery] int pageIndex = DefaultPageIndex, [FromQuery] int pageSize = DefaultPageSize)
    {
    ...
    [ValidateModelState]
    [ProducesResponseType(statusCode: (int) HttpStatusCode.OK, type: typeof(PagedDataEx<GraphNode>))]
    public override ActionResult<PagedDataEx<GraphNode>> ByOwner([FromRoute] [Required] Guid ownerId, [FromQuery] int pageIndex = DefaultPageIndex, [FromQuery] int pageSize = DefaultPageSize)
    {
