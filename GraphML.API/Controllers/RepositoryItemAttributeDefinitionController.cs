...
namespace GraphML.API.Controllers
{
  ...
  public sealed class RepositoryItemAttributeDefinitionController : OwnedGraphMLController<RepositoryItemAttributeDefinition>
  {
    ...
    public override ActionResult<PagedDataEx<RepositoryItemAttributeDefinition>> ByOwners(
    ...
    [ValidateModelState]
    [ProducesResponseType(statusCode: (int) HttpStatusCode.OK, type: typeof(PagedDataEx<RepositoryItemAttributeDefinition>))]
    public override ActionResult<PagedDataEx<RepositoryItemAttributeDefinition>> ByOwner(
