...
namespace GraphML.API.Controllers
{
	...
	public sealed class RepositoryItemAttributeDefinitionController : OwnedGraphMLController<RepositoryItemAttributeDefinition>
	{
		...
		[ProducesResponseType(statusCode: (int)HttpStatusCode.OK, type: typeof(IEnumerable<RepositoryItemAttributeDefinition>))]
		[ProducesResponseType(statusCode: (int)HttpStatusCode.NotFound)]
		public override IActionResult Create([FromBody][Required] IEnumerable<RepositoryItemAttributeDefinition> entity)
		{
		...
		[ProducesResponseType(statusCode: (int)HttpStatusCode.NotFound)]
		public override IActionResult Delete([FromBody][Required] IEnumerable<RepositoryItemAttributeDefinition> entity)
		{
		...
		[ProducesResponseType(statusCode: (int)HttpStatusCode.OK)]
		[ProducesResponseType(statusCode: (int)HttpStatusCode.NotFound)]
		public override IActionResult Update([FromBody][Required] IEnumerable<RepositoryItemAttributeDefinition> entity)
		{
