...
namespace GraphML.API.Controllers
{
  ...
  public sealed class RepositoryController : OwnedGraphMLController<Repository>
  {
    ...
    [ValidateModelState]
    [ProducesResponseType(statusCode: (int) HttpStatusCode.OK, type: typeof(IEnumerable<Repository>))]
    public override ActionResult<IEnumerable<Repository>> ByOwner([FromRoute] [Required] Guid ownerId, [FromQuery] int pageIndex = DefaultPageIndex, [FromQuery] int pageSize = DefaultPageSize)
    {
