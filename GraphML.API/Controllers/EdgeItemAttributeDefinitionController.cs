...
namespace GraphML.API.Controllers
{
  ...
  public sealed class EdgeItemAttributeDefinitionController : OwnedGraphMLController<EdgeItemAttributeDefinition>
  {
    ...
    public override ActionResult<PagedDataEx<EdgeItemAttributeDefinition>> ByOwners(
    ...
    [ValidateModelState]
    [ProducesResponseType(statusCode: (int) HttpStatusCode.OK, type: typeof(PagedDataEx<EdgeItemAttributeDefinition>))]
    public override ActionResult<PagedDataEx<EdgeItemAttributeDefinition>> ByOwner(
