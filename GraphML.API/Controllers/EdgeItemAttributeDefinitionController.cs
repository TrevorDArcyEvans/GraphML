...
namespace GraphML.API.Controllers
{
	...
	public sealed class EdgeItemAttributeDefinitionController : OwnedGraphMLController<EdgeItemAttributeDefinition>
	{
		...
		[ProducesResponseType(statusCode: (int)HttpStatusCode.OK, type: typeof(IEnumerable<EdgeItemAttributeDefinition>))]
		[ProducesResponseType(statusCode: (int)HttpStatusCode.NotFound)]
		public override IActionResult Create([FromBody][Required] IEnumerable<EdgeItemAttributeDefinition> entity)
		{
		...
		[ProducesResponseType(statusCode: (int)HttpStatusCode.NotFound)]
		public override IActionResult Delete([FromBody][Required] IEnumerable<EdgeItemAttributeDefinition> entity)
		{
		...
		[ProducesResponseType(statusCode: (int)HttpStatusCode.OK)]
		[ProducesResponseType(statusCode: (int)HttpStatusCode.NotFound)]
		public override IActionResult Update([FromBody][Required] IEnumerable<EdgeItemAttributeDefinition> entity)
		{
