...
namespace GraphML.API.Controllers
{
  ...
  public sealed class NodeItemAttributeController : OwnedGraphMLController<NodeItemAttribute>
  {
    /// <summary>
    /// constructor
    /// </summary>
    ...
    [Route(nameof(ByIds))]
    [ValidateModelState]
    [SwaggerResponse(statusCode: (int)HttpStatusCode.OK, type: typeof(IEnumerable<NodeItemAttribute>), description: "Success")]
    ...
    [ValidateModelState]
    [SwaggerResponse(statusCode: (int)HttpStatusCode.OK, type: typeof(PaginatedList<NodeItemAttribute>), description: "Success - if no Entities found, return empty list")]
    ...
    public override IActionResult Create([FromBody] IEnumerable<NodeItemAttribute> entity)
    {
    ...
    [SwaggerResponse(statusCode: (int)HttpStatusCode.NotFound, description: "Incorrect reference in Entities")]
    public override IActionResult Delete([FromBody] IEnumerable<NodeItemAttribute> entity)
    {
    ...
    [SwaggerResponse(statusCode: (int)HttpStatusCode.OK, description: "Success")]
    [SwaggerResponse(statusCode: (int)HttpStatusCode.NotFound, description: "Incorrect reference in Entities")]
    public override IActionResult Update([FromBody] IEnumerable<NodeItemAttribute> entity)
    {
