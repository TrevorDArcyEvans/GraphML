...
namespace GraphML.API.Controllers
{
  ...
  public sealed class NodeController : RepositoryItemController<Node>
  {
    ...
    public override ActionResult<PagedDataEx<Node>> ByOwners([FromBody] [Required] IEnumerable<Guid> ownerIds, [FromQuery] int pageIndex = DefaultPageIndex, [FromQuery] int pageSize = DefaultPageSize)
    {
    ...
    [ValidateModelState]
    [ProducesResponseType(statusCode: (int) HttpStatusCode.OK, type: typeof(PagedDataEx<Node>))]
    public override ActionResult<PagedDataEx<Node>> ByOwner([FromRoute] [Required] Guid ownerId, [FromQuery] int pageIndex = DefaultPageIndex, [FromQuery] int pageSize = DefaultPageSize)
    {
