...
namespace GraphML.API.Controllers
{
  ...
  public sealed class GraphItemAttributeController : OwnedGraphMLController<GraphItemAttribute>
  {
    ...
    [ValidateModelState]
    [ProducesResponseType(statusCode: (int) HttpStatusCode.OK, type: typeof(IEnumerable<GraphItemAttribute>))]
    public override ActionResult<IEnumerable<GraphItemAttribute>> ByOwners([FromBody] [Required] IEnumerable<Guid> ownerIds, [FromQuery] int pageIndex = DefaultPageIndex, [FromQuery] int pageSize = DefaultPageSize)
    {
    ...
    [ValidateModelState]
    [ProducesResponseType(statusCode: (int) HttpStatusCode.OK, type: typeof(IEnumerable<GraphItemAttribute>))]
    public override ActionResult<IEnumerable<GraphItemAttribute>> ByOwner([FromRoute] [Required] Guid ownerId, [FromQuery] int pageIndex = DefaultPageIndex, [FromQuery] int pageSize = DefaultPageSize)
    {
