...
namespace GraphML.API.Controllers
{
  ...
  public sealed class ChartEdgeController : OwnedGraphMLController<ChartEdge>
  {
    private readonly IChartEdgeLogic _chartEdgeLogic;

    /// <summary>
    /// constructor
    /// </summary>
    /// <param name="logic">business logic</param>
    public ChartEdgeController(IChartEdgeLogic logic) :
      base(logic)
    {
      _chartEdgeLogic = logic;
    }
    ...
    [Route(nameof(ByIds))]
    [ValidateModelState]
    [ProducesResponseType(statusCode: (int) HttpStatusCode.OK, type: typeof(IEnumerable<ChartEdge>))]
    [ProducesResponseType(statusCode: (int) HttpStatusCode.NotFound)]
    public override ActionResult<IEnumerable<ChartEdge>> ByIds([FromBody] [Required] IEnumerable<Guid> ids)
    {
    ...
    [ValidateModelState]
    [ProducesResponseType(statusCode: (int) HttpStatusCode.OK, type: typeof(PagedDataEx<ChartEdge>))]
    public override ActionResult<PagedDataEx<ChartEdge>> ByOwners(
    ...
    [ValidateModelState]
    [ProducesResponseType(statusCode: (int) HttpStatusCode.OK, type: typeof(PagedDataEx<ChartEdge>))]
    public override ActionResult<PagedDataEx<ChartEdge>> ByOwner(
    ...
    [ProducesResponseType(statusCode: (int) HttpStatusCode.OK, type: typeof(IEnumerable<ChartEdge>))]
    [ProducesResponseType(statusCode: (int) HttpStatusCode.NotFound)]
    public override ActionResult<IEnumerable<ChartEdge>> Create([FromBody] [Required] IEnumerable<ChartEdge> entity)
    {
    ...
    [ProducesResponseType(statusCode: (int) HttpStatusCode.NotFound)]
    public override ActionResult Delete([FromBody] [Required] IEnumerable<ChartEdge> entity)
    {
    ...
    [ProducesResponseType(statusCode: (int) HttpStatusCode.OK)]
    [ProducesResponseType(statusCode: (int) HttpStatusCode.NotFound)]
    public override ActionResult Update([FromBody] [Required] IEnumerable<ChartEdge> entity)
    {
    ...
    /// <summary>
    /// Retrieve a <see cref="ChartEdge"/> corresponding to an underlying <see cref="GraphItem"/>
    ...
    [ValidateModelState]
    [ProducesResponseType(statusCode: (int) HttpStatusCode.OK, type: typeof(IEnumerable<ChartEdge>))]
    public ActionResult<IEnumerable<ChartEdge>> ByGraphItems(
      [FromRoute] Guid chartId,
      [FromBody] IEnumerable<Guid> graphItemId)
    {
      return Ok(_chartEdgeLogic.ByGraphItems(chartId, graphItemId));
    }
  }
}
