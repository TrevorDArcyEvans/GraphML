...
namespace GraphML.API.Controllers
{
  ...
  public sealed class TimelineNodeController : OwnedGraphMLController<TimelineNode>
  {
    private readonly ITimelineNodeLogic _timelineNodeLogic;

    /// <summary>
    /// constructor
    /// </summary>
    /// <param name="logic">business logic</param>
    public TimelineNodeController(ITimelineNodeLogic logic) :
      base(logic)
    {
      _timelineNodeLogic = logic;
    }
    ...
    [Route(nameof(ByIds))]
    [ValidateModelState]
    [ProducesResponseType(statusCode: (int) HttpStatusCode.OK, type: typeof(IEnumerable<TimelineNode>))]
    [ProducesResponseType(statusCode: (int) HttpStatusCode.NotFound)]
    public override ActionResult<IEnumerable<TimelineNode>> ByIds([FromBody] [Required] IEnumerable<Guid> ids)
    {
    ...
    [ValidateModelState]
    [ProducesResponseType(statusCode: (int) HttpStatusCode.OK, type: typeof(PagedDataEx<TimelineNode>))]
    public override ActionResult<PagedDataEx<TimelineNode>> ByOwners(
    ...
    [ValidateModelState]
    [ProducesResponseType(statusCode: (int) HttpStatusCode.OK, type: typeof(PagedDataEx<TimelineNode>))]
    public override ActionResult<PagedDataEx<TimelineNode>> ByOwner(
    ...
    [ProducesResponseType(statusCode: (int) HttpStatusCode.OK, type: typeof(IEnumerable<TimelineNode>))]
    [ProducesResponseType(statusCode: (int) HttpStatusCode.NotFound)]
    public override ActionResult<IEnumerable<TimelineNode>> Create([FromBody] [Required] IEnumerable<TimelineNode> entity)
    {
    ...
    [ProducesResponseType(statusCode: (int) HttpStatusCode.NotFound)]
    public override ActionResult Delete([FromBody] [Required] IEnumerable<TimelineNode> entity)
    {
    ...
    [ProducesResponseType(statusCode: (int) HttpStatusCode.OK)]
    [ProducesResponseType(statusCode: (int) HttpStatusCode.NotFound)]
    public override ActionResult Update([FromBody] [Required] IEnumerable<TimelineNode> entity)
    {
    ...
    /// <summary>
    /// Retrieve a <see cref="TimelineNode"/> corresponding to an underlying <see cref="GraphItem"/>
    ...
    [ValidateModelState]
    [ProducesResponseType(statusCode: (int) HttpStatusCode.OK, type: typeof(IEnumerable<TimelineNode>))]
    public ActionResult<IEnumerable<TimelineNode>> ByGraphItems(
      [FromRoute] Guid timelineId,
      [FromBody] IEnumerable<Guid> graphItemId)
    {
      return Ok(_timelineNodeLogic.ByGraphItems(timelineId, graphItemId));
    }
  }
}
