...
namespace GraphML.API.Controllers
{
  ...
  public sealed class EdgeItemAttributeController : OwnedGraphMLController<EdgeItemAttribute>
  {
    ...
    public override ActionResult<IEnumerable<EdgeItemAttribute>> ByIds([FromBody] [Required] IEnumerable<Guid> ids)
    {
    ...
    [ValidateModelState]
    [ProducesResponseType(statusCode: (int) HttpStatusCode.OK, type: typeof(IEnumerable<EdgeItemAttribute>))]
    public override ActionResult<IEnumerable<EdgeItemAttribute>> ByOwners([FromBody] [Required] IEnumerable<Guid> ownerIds, [FromQuery] int pageIndex = DefaultPageIndex, [FromQuery] int pageSize = DefaultPageSize)
    {
    ...
    [ValidateModelState]
    [ProducesResponseType(statusCode: (int) HttpStatusCode.OK, type: typeof(IEnumerable<EdgeItemAttribute>))]
    public override ActionResult<IEnumerable<EdgeItemAttribute>> ByOwner([FromRoute] [Required] Guid ownerId, [FromQuery] int pageIndex = DefaultPageIndex, [FromQuery] int pageSize = DefaultPageSize)
    {
    ...
    [ProducesResponseType(statusCode: (int) HttpStatusCode.OK, type: typeof(IEnumerable<EdgeItemAttribute>))]
    [ProducesResponseType(statusCode: (int) HttpStatusCode.NotFound)]
    public override ActionResult<IEnumerable<EdgeItemAttribute>> Create([FromBody] [Required] IEnumerable<EdgeItemAttribute> entity)
    {
    ...
    [ProducesResponseType(statusCode: (int) HttpStatusCode.NotFound)]
    public override ActionResult Delete([FromBody] [Required] IEnumerable<EdgeItemAttribute> entity)
    {
    ...
    [ProducesResponseType(statusCode: (int) HttpStatusCode.OK)]
    [ProducesResponseType(statusCode: (int) HttpStatusCode.NotFound)]
    public override ActionResult Update([FromBody] [Required] IEnumerable<EdgeItemAttribute> entity)
    {
