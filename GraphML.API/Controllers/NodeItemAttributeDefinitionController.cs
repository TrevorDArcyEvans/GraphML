...
namespace GraphML.API.Controllers
{
  ...
  public sealed class NodeItemAttributeDefinitionController : OwnedGraphMLController<NodeItemAttributeDefinition>
  {
    ...
    public override ActionResult<IEnumerable<NodeItemAttributeDefinition>> ByIds([FromBody] [Required] IEnumerable<Guid> ids)
    {
    ...
    [ValidateModelState]
    [ProducesResponseType(statusCode: (int) HttpStatusCode.OK, type: typeof(PagedDataEx<NodeItemAttributeDefinition>))]
    public override ActionResult<PagedDataEx<NodeItemAttributeDefinition>> ByOwners([FromBody] [Required] IEnumerable<Guid> ownerIds, [FromQuery] int pageIndex = DefaultPageIndex, [FromQuery] int pageSize = DefaultPageSize)
    {
    ...
    [ValidateModelState]
    [ProducesResponseType(statusCode: (int) HttpStatusCode.OK, type: typeof(PagedDataEx<NodeItemAttributeDefinition>))]
    public override ActionResult<PagedDataEx<NodeItemAttributeDefinition>> ByOwner([FromRoute] [Required] Guid ownerId, [FromQuery] int pageIndex = DefaultPageIndex, [FromQuery] int pageSize = DefaultPageSize)
    {
    ...
    [ProducesResponseType(statusCode: (int) HttpStatusCode.OK, type: typeof(IEnumerable<NodeItemAttributeDefinition>))]
    [ProducesResponseType(statusCode: (int) HttpStatusCode.NotFound)]
    public override ActionResult<IEnumerable<NodeItemAttributeDefinition>> Create([FromBody] [Required] IEnumerable<NodeItemAttributeDefinition> entity)
    {
    ...
    [ProducesResponseType(statusCode: (int) HttpStatusCode.NotFound)]
    public override ActionResult Delete([FromBody] [Required] IEnumerable<NodeItemAttributeDefinition> entity)
    {
    ...
    [ProducesResponseType(statusCode: (int) HttpStatusCode.OK)]
    [ProducesResponseType(statusCode: (int) HttpStatusCode.NotFound)]
    public override ActionResult Update([FromBody] [Required] IEnumerable<NodeItemAttributeDefinition> entity)
    {
