...
namespace GraphML.API.Controllers
{
  ...
  public sealed class NodeItemAttributeDefinitionController : OwnedGraphMLController<NodeItemAttributeDefinition>
  {
    ...
    [ValidateModelState]
    [ProducesResponseType(statusCode: (int) HttpStatusCode.OK, type: typeof(IEnumerable<NodeItemAttributeDefinition>))]
    public override ActionResult<IEnumerable<NodeItemAttributeDefinition>> ByOwners([FromBody] [Required] IEnumerable<Guid> ownerIds, [FromQuery] int pageIndex = DefaultPageIndex, [FromQuery] int pageSize = DefaultPageSize)
    {
    ...
    [ValidateModelState]
    [ProducesResponseType(statusCode: (int) HttpStatusCode.OK, type: typeof(IEnumerable<NodeItemAttributeDefinition>))]
    public override ActionResult<IEnumerable<NodeItemAttributeDefinition>> ByOwner([FromRoute] [Required] Guid ownerId, [FromQuery] int pageIndex = DefaultPageIndex, [FromQuery] int pageSize = DefaultPageSize)
    {
