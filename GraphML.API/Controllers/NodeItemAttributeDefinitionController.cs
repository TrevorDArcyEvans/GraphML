...
namespace GraphML.API.Controllers
{
  ...
  public sealed class NodeItemAttributeDefinitionController : OwnedGraphMLController<NodeItemAttributeDefinition>
  {
    ...
    public override ActionResult<PagedDataEx<NodeItemAttributeDefinition>> ByOwners(
    ...
    [ValidateModelState]
    [ProducesResponseType(statusCode: (int) HttpStatusCode.OK, type: typeof(PagedDataEx<NodeItemAttributeDefinition>))]
    public override ActionResult<PagedDataEx<NodeItemAttributeDefinition>> ByOwner(
