...
namespace GraphML.API.Controllers
{
  ...
  public sealed class EdgeController : RepositoryItemController<Edge>
  {
    ...
    [ValidateModelState]
    [ProducesResponseType(statusCode: (int) HttpStatusCode.OK, type: typeof(IEnumerable<Edge>))]
    public override ActionResult<IEnumerable<Edge>> ByOwner([FromRoute] [Required] Guid ownerId, [FromQuery] int pageIndex = DefaultPageIndex, [FromQuery] int pageSize = DefaultPageSize)
    {
