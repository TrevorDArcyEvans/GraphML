...
namespace GraphML.API.Controllers
{
  ...
  public sealed class RepositoryManagerController : OwnedGraphMLController<RepositoryManager>
  {
    ...
    [ValidateModelState]
    [ProducesResponseType(statusCode: (int) HttpStatusCode.OK, type: typeof(IEnumerable<RepositoryManager>))]
    public override ActionResult<IEnumerable<RepositoryManager>> ByOwner([FromRoute] Guid ownerId, [FromQuery] int pageIndex = DefaultPageIndex, [FromQuery] int pageSize = DefaultPageSize)
    {
