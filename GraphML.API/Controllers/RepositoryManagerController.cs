...
namespace GraphML.API.Controllers
{
  ...
  public sealed class RepositoryManagerController : OwnedGraphMLController<RepositoryManager>
  {
    ...
    [ValidateModelState]
    [ProducesResponseType(statusCode: (int) HttpStatusCode.OK, type: typeof(IEnumerable<RepositoryManager>))]
    public override ActionResult<IEnumerable<RepositoryManager>> ByOwners([FromBody] [Required] IEnumerable<Guid> ownerIds, [FromQuery] int pageIndex = DefaultPageIndex, [FromQuery] int pageSize = DefaultPageSize)
    {
    ...
    [ValidateModelState]
    [ProducesResponseType(statusCode: (int) HttpStatusCode.OK, type: typeof(IEnumerable<RepositoryManager>))]
    public override ActionResult<IEnumerable<RepositoryManager>> ByOwner([FromRoute] [Required] Guid ownerId, [FromQuery] int pageIndex = DefaultPageIndex, [FromQuery] int pageSize = DefaultPageSize)
    {
