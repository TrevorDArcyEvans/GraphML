...
namespace GraphML.API.Controllers
{
  ...
  public sealed class GraphEdgeController : OwnedGraphMLController<GraphEdge>
  {
    ...
    public override ActionResult<PagedDataEx<GraphEdge>> ByOwners([FromBody] [Required] IEnumerable<Guid> ownerIds, [FromQuery] int pageIndex = DefaultPageIndex, [FromQuery] int pageSize = DefaultPageSize)
    {
    ...
    [ValidateModelState]
    [ProducesResponseType(statusCode: (int) HttpStatusCode.OK, type: typeof(PagedDataEx<GraphEdge>))]
    public override ActionResult<PagedDataEx<GraphEdge>> ByOwner([FromRoute] [Required] Guid ownerId, [FromQuery] int pageIndex = DefaultPageIndex, [FromQuery] int pageSize = DefaultPageSize)
    {
