...
namespace GraphML.API.Controllers
{
  ...
  public sealed class GraphItemAttributeDefinitionController : OwnedGraphMLController<GraphItemAttributeDefinition>
  {
    ...
    public override ActionResult<PagedDataEx<GraphItemAttributeDefinition>> ByOwners(
    ...
    [ValidateModelState]
    [ProducesResponseType(statusCode: (int) HttpStatusCode.OK, type: typeof(PagedDataEx<GraphItemAttributeDefinition>))]
    public override ActionResult<PagedDataEx<GraphItemAttributeDefinition>> ByOwner(
