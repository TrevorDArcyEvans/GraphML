...
namespace GraphML.API.Controllers
{
	...
	public sealed class GraphItemAttributeDefinitionController : OwnedGraphMLController<GraphItemAttributeDefinition>
	{
		...
		[ProducesResponseType(statusCode: (int)HttpStatusCode.OK, type: typeof(IEnumerable<GraphItemAttributeDefinition>))]
		[ProducesResponseType(statusCode: (int)HttpStatusCode.NotFound)]
		public override IActionResult Create([FromBody][Required] IEnumerable<GraphItemAttributeDefinition> entity)
		{
		...
		[ProducesResponseType(statusCode: (int)HttpStatusCode.NotFound)]
		public override IActionResult Delete([FromBody][Required] IEnumerable<GraphItemAttributeDefinition> entity)
		{
		...
		[ProducesResponseType(statusCode: (int)HttpStatusCode.OK)]
		[ProducesResponseType(statusCode: (int)HttpStatusCode.NotFound)]
		public override IActionResult Update([FromBody][Required] IEnumerable<GraphItemAttributeDefinition> entity)
		{
